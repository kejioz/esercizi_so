...
int main(){
	...
	ds_shm = shmget(k_sh,sizeof(struct codaCircolare),IPC_CREAT|0664);
	...
	struct codaCircolare* p;
	p = (struct codaCircolare*) shmat(ds_shm,0,0);
