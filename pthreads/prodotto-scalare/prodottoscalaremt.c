...
/*
Struttura contenente i vettori e il risultato. Mi serve per storare più cose
*/
...
void *dotprod(void*arg){
    ...
    */
    ...
    //Devo bloccare il mutex prima di aggiornare la variabile condivisa doctstr.sum e sblocco dopo agg
